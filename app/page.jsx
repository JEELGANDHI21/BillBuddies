...
export default function Home() {
  return (
    <div className="flex flex-col pt-16">
      <section className="mt-20 pb-12 space-y-18 md:space-y-20 px-5">
        <div className="container mx-auto px-5 md:px-6 text-center space-y-6">
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row justify-center">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-blue-700 text-blue-700 hover:bg-green-50"
            >
